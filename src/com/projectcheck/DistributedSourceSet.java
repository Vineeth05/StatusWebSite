...
public class DistributedSourceSet extends HttpServlet {
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
     ...
     String json=req.getParameter("message");
		...
		DistributedSource str = objectMapper.readValue(json, DistributedSource.class);
		System.out.println("value setted");
            ...
            String msgBody="A issue has been reported on one of our services (DistributedSource) which you are registered with.Sorry.";
