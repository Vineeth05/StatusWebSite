...
public class GetFullClient extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		   String button=req.getParameter("id");
		System.out.println("Funtion Comes inside fetch servlet of getfullclient");
    ...
    try{
    	Fullclient results =(Fullclient)pmf.getObjectById(Fullclient.class,button);
  ...
  out.print(json);
      	  ...
      	  pmf.close();
		  out.flush();
		  System.out.println("function closes here");
        }
