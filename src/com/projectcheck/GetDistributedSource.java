...
public class GetDistributedSource extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		   String button=req.getParameter("id");
		System.out.println("Funtion Comes inside fetch servlet of DistributedSource");
    ...
    System.out.println("data value is setted");
      try{
    	  DistributedSource results =(DistributedSource)pmf.getObjectById(DistributedSource.class,button);
    ...
    out.print(json);
		  ...
		  out.flush();
		  System.out.println("distributedSourcefunction closes here"); 
      }
