...
public class GetSwitchBoard extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		   String button=req.getParameter("id");
		System.out.println("Funtion Comes inside fetch servlet of switchboard");
    ...
    try{
    	SwitchBoard results =(SwitchBoard)pmf.getObjectById(SwitchBoard.class,button);
  ...
  out.print(json);
  	  ...
  	  pmf.close(); 
	  out.flush();
	  System.out.println("swithcboardfunction closes here");	
    }
