...
public class AnswerConnectSet extends HttpServlet {
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
     ...
     String json=req.getParameter("message");
		...
		AnswerConnect str = objectMapper.readValue(json, AnswerConnect.class);
		System.out.println("value setted");
            ...
            String msgBody="A issue has been reported on one of our services (AnswerConnect)  which you are registered with.Sorry.";
